...
import (
	...
	"github.com/landers1037/blogo/routers/api/admin"
	"github.com/landers1037/blogo/routers/api/article"
	"github.com/landers1037/blogo/routers/api/dashboard"
	"github.com/landers1037/blogo/routers/api/message"
	"github.com/landers1037/blogo/routers/api/statistic"
)
...
func InitRouter() *gin.Engine {
	...
	addSimpleAuth(apiArticle)
	{
		...
		apiArticle.GET("/tag", article.GetarticleBytag)   // 获取对应标签下的文章
